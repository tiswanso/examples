...
REMOTE_IP=${clus2_IP} KCONF=${KCONF1} TAG=${VL3_IMGTAG} examples/vl3_basic/scripts/vl3_interdomain.sh --ipamOctet=22 --serviceName=${SERVICENAME}
...
REMOTE_IP=${clus1_IP} KCONF=${KCONF2} TAG=${VL3_IMGTAG} examples/vl3_basic/scripts/vl3_interdomain.sh --ipamOctet=33 --serviceName=${SERVICENAME}
