...
type srAppsCompositeEndpoint string

func (srAppsce srAppsCompositeEndpoint) AddCompositeEndpoints(nsConfig *common.NSConfiguration, ucnfEndpoint *nseconfig.Endpoint) *[]networkservice.NetworkServiceServer {
	...
	}).Infof("Creating SR-Apps IPAM endpoint")
...
var  CompositeEndpointPlugin srAppsCompositeEndpoint
